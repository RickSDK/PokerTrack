...
@interface HexaFieldCell (Private)
// Internal methods.
...
@implementation HexaFieldCell


@synthesize a1, a2, b1, b2, c1, c2;
@synthesize a1Color, a2Color, b1Color, b2Color, c1Color, c2Color;
...
+ (UIView *)headerView:(NSArray *)fieldNameArray 
	...
	{
		CGRect rect = CGRectMake(0,0, width, [HexaFieldCell cellHeight]);
		...
		[HexaFieldCell customizeLabel:fa1 a2:fa2 b1:fb1 b2:fb2 c1:fc1 c2:fc2];
		[HexaFieldCell layoutSubviews:fa1 a2:fa2 
								   b1:fb1 b2:fb2
								   c1:fc1 c2:fc2 
							  inBound:rect 
							 topSplit:top 
...
- (id)initWithStyle:(UITableViewCellStyle)style 
	...
	if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
		...
		[HexaFieldCell customizeLabel:a1 a2:a2 b1:b1 b2:b2 c1:c1 c2:c2];
		//initialize color
...
- (void)layoutSubviews {
	...
	[HexaFieldCell layoutSubviews:a1 a2:a2 b1:b1 b2:b2 c1:c1 c2:c2 
